                ...
                child: Stack(
                  children: <Widget>[
                    Positioned(
                      left: width * 0.5,
                      child: Image(
                        image: const AssetImage('assets/result.png'),
                        width: width * 0.3,
                      ),
                    ),
                    Row(
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsets.fromLTRB(
                            width * 0.05, height * 0.25 * 0.65, 0, 0),
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  image: NetworkImage(
                      'https://www.mathmammoth.com/videos/grade_6/screenshot-inequalities-video.jpg'),
                  fit: BoxFit.cover,
                )),
              ),
            ),
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding:
                          EdgeInsets.symmetric(vertical: height * 0.25 * 0.1),
                      child: Container(
                        width: width * 0.18,
                        decoration: BoxDecoration(
                        ...
                        child: Column(
                          children: const <Widget>[
                            Padding(
                              padding: EdgeInsets.fromLTRB(8, 6, 6, 4),
                              child: Text('125',
                                  style: TextStyle(
                                      fontSize: 20.0,
                                      color: Colors.white,
